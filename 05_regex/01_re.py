...
- Búsqueda avanzada:  Encontrar patrons específicos en textos grandes de forma rápida y precisa
...
# EJERCICIO 01
# Encuentra la primera ocurrencia de la palabra "IA" en el siguiente texto e indica en que posicón empieza y termina la coincidencia.
...
# ----------------------------------------------
# .finditer() devuelve un iterador que contiene todos los resultados de l búsqueda
...
text = "Todo el mundo dice que la IA nos va a quitar el trabajo. Pero solo hace falta ver cómo la puede cagar con las Regex para ir con cuidado. Pero la ia no es tan mala. ¡Viva la iA!"
pattern = "IA"
