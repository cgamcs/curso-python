...
# Para ver si un número es pas
# siempre usamos el módulo %
# nos da el resto de la división: eggs % 2 == 0

def count_carnivore_dinosaur_eggs(egg_list: list) -> int:
  """
  Esta función recibe una lista de numeros enteros que representan la cantidad de huevos que
  han puesto diferentes dinosaurios en el parque jurásico y los de número par son de
  carnívoros. Devuelve un número con la suma de todos los huevos de carnívoros.
  """
